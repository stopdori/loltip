  ...
  return (
    <div className={`flex items-center gap-1 transition-opacity duration-300 ${mounted ? "opacity-100" : "opacity-0"}`}>
      <a
        ...
        className="flex-1 block rounded-2xl bg-slate-800/40 ring-1 ring-white/10 px-2 sm:px-5 py-4 overflow-hidden cursor-pointer hover:ring-yellow-400/60 transition-all min-h-[120px]"
      >
        {/* 헤더 */}
