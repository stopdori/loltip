...
export const GIMMICK_CATEGORIES: CategoryGroup<GimmickTagId>[] = [
  ...
  },
  {
    ...
    keys: ["SELF_MAXHP_SCALE", "SELF_BONUS_HP_SCALE", "SELF_MISSING_HP_SCALE", "TARGET_MAXHP_SCALE", "TARGET_CURRENT_HP_SCALE", "TARGET_MISSING_HP_SCALE", "AD_SCALE", "AP_SCALE", "LEVEL_SCALE", "AS_SCALE", "MS_SCALE", "HP_SCALE", "MANA_SCALE", "ENERGY_SCALE"],
  },
  {
