...
export const anivia_diana: MatchupSummary = {
  ...
  highlightsByChamp: {
    anivia: {
      ko: ["애니비아 Q의 [[STUN]]로 다이애나 E의 이동을 끊을 수 없음. 단, [[STUN]]은 남아있음.", "애니비아 W(벽)의 [[AIRBORNE]]으로 다이애나 E(붕대)의 이동을 끊을 수 있음.", "애니비아 W(벽)의 [[AIRBORNE]]으로 다이애나 R의 [[GRAB]]에 끌려가는 아군의 이동을 끊을 수 있긴 함."],
