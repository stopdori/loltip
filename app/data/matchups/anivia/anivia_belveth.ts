...
export const anivia_belveth: MatchupSummary = {
  ...
  highlightsByChamp: {
    anivia: {
      ...
      en: ["Anivia's Q [[STUN]] cannot interrupt Bel'Veth's Q or R [[DASH]]. \n However, [[STUN]] still applies.", "Anivia's W [[TERRAIN]] [[AIRBORNE]] can interrupt Bel'Veth's Q [[DASH]].", "Anivia's Q [[STUN]] and W [[TERRAIN]] [[AIRBORNE]] can interrupt Bel'Veth's E [[SKILL_CHANNEL]]."],
    },
    belveth: {
      ko: [],
      en: [],
