...
export const anivia_belveth: MatchupSummary = {
  ...
  highlightsByChamp: {
    anivia: {
      ko: ["애니비아 Q의 [[STUN]]로 벨베스 Q, R의 이동을 끊을 수 없음. 단, [[STUN]]은 남아있음.", "애니비아 Q의 [[STUN]], W(벽)의 [[AIRBORNE]]으로 벨베스 R의 이동을 끊을 수 없음. 단, Q의 [[STUN]]은 남아있음.", "애니비아 W(벽)의 [[AIRBORNE]]으로 벨베스 Q의 이동을 끊을 수 있음.", "애니비아 Q의 [[STUN]], W(벽)의 [[AIRBORNE]]으로 벨베스 E(채널링)를 끊을 수 있음."],
