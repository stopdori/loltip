...
export const anivia_braum: MatchupSummary = {
  ...
  highlightsByChamp: {
    anivia: {
      ko: ["애니비아 Q의 [[STUN]]로 브라움 W의 [[DASH]을 끊을 수 없음. 단, [[STUN]]은 남아있음.", "애니비아 W(벽)의 [[AIRBORNE]]으로 브라움 W의 [[DASH]을 끊을 수 있음."],
      en: ["Anivia's Q [[STUN]] cannot interrupt Braum's W movement. However, [[STUN]] still applies.", "Anivia's W (wall) [[AIRBORNE]] can interrupt Braum's W movement."],
    },
    braum: {
