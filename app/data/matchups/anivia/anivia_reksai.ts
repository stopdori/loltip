  ...
  highlightsByChamp: {
    anivia: {
      ko: ["Q의 [[STUN]]로 렉사이 매복폼 E의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.", 
        "W([[TERRAIN]])의 [[AIRBORNE]]으로 렉사이 매복폼 E의 [[DASH]]을 끊을 수 있음.", ],
      en: ["Q [[STUN]] cannot interrupt Rek'Sai's burrowed E [[DASH]]. \n However, [[STUN]] still applies.", "W [[TERRAIN]] [[AIRBORNE]] can interrupt Rek'Sai's burrowed E [[DASH]]."],
    },
    reksai: {
