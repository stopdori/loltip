...
export const anivia_aurelionsol: MatchupSummary = {
  ...
  highlightsByChamp: {
    anivia: {
      ko: ["애니비아 Q의 [[STUN]], W([[TERRAIN]])의 [[AIRBORNE]]으로 아우렐리온 솔(아우솔) Q, W의 [[SKILL_CHANNEL]]을 끊을 수 있음.", 
        "애니비아 W([[TERRAIN]])의 [[AIRBORNE]]으로 아우솔 E, R을 시전 중일 때 뒤로 밀어내면 E, R [[AOE]]도 같이 뒤로 밀림."],
