...
export const anivia_blitzcrank: MatchupSummary = {
  ...
  highlightsByChamp: {
    anivia: {
      ko: ["W([[TERRAIN]])의 [[AIRBORNE]]으로 블랭(블츠)(블크) Q의 [[GRAB]]에 끌려가는 아군의 이동을 끊을 수 있음. \n 즉, 구조가능 (이론상)."],
      en: ["W [[TERRAIN]] [[AIRBORNE]] can interrupt an ally being pulled by Blitzcrank's Q [[GRAB]], effectively rescuing them. \n (theoretically)"],
    },
    blitzcrank: {
