...
export const anivia_gwen: MatchupSummary = {
  ...
  highlightsByChamp: {
    anivia: {
      ko: ["애니비아 W(벽)을 그웬 W(그면상) 위로 사용하면 그웬이 벽과 겹쳐지지만, 짧은쪽으로 나올 수 있고.\n그웬이 벽 밖으로 한번 나오면 벽을 다시 통과할 수 없음."],
      en: ["If Anivia places W (wall) on top of Gwen's W (zone), Gwen overlaps with the wall but can exit from the shorter side.\nOnce Gwen exits the wall, she cannot pass through it again."],
    },
    gwen: {
