...
export const alistar_sejuani: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ...
      en: ["Alistar's Q and W can interrupt Sejuani's Q", "Alistar's E [[STUN]] cannot interrupt Sejuani's Q. However, the [[STUN]] still applies.", "[TODO: 알리스타 R의 [[CC_CLEANSE]]로 세주아니 Q의 [[AIRBORNE]], E의 [[STUN]], R의 [[SLOW]] [[STUN]] 해제할 수 있음]"],
    },
    sejuani: {
      ko: [],
      en: [],
