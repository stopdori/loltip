...
export const alistar_rammus: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ...
      en: ["Alistar's Q, W, and E can interrupt Rammus's Q\\n[TODO: 단, W는 대신 부딪혀주는 방법으로 끊는것]", "Alistar's R [[CC_CLEANSE]] can cleanse 람머스 Q [[SLOW]], E [[TAUNT]], R [[SLOW]]"],
    },
    rammus: {
      ko: ["람머스 Q와 알리스타 W가 부딪히면 람머스 Q는 유효 알리스타 W는 무효화\n그래서 알리스타는 람머스 Q에 WQ자체가 불가능"],
      en: ["[TODO: 람머스 Q와 알리스타 W가 부딪히면 람머스 Q는 유효 알리스타 W는 무효화]\\n[TODO: 그래서 알리스타는 람머스 Q에 WQ자체가 불가능]"],
    },
  },
};
