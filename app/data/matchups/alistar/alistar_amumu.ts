  ...
  highlightsByChamp: {
    ...
    amumu: {
      ko: ["Q의 [[STUN]]로 알리스타 W의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음. \n 단, 아무무 Q의 [[HOMING]] [[DASH]]으로 따라갈 수 있음.", 
        "R의 [[STUN]]로 알리스타 W의 [[DASH]]을 끊을 수 있음.", 
        "Q의 [[CC_BUFFER]]로 알리스타 Q의 [[AIRBORNE]], W의 [[KNOCKBACK]], E의 [[STUN]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[STUN]]은 남아있음."],
      en: ["Q [[STUN]] cannot interrupt Alistar's W [[DASH]]. \n However, the [[STUN]] still applies. \n However, Amumu's Q [[HOMING]] [[DASH]] can follow.", "R [[STUN]] can interrupt Alistar's W [[DASH]].", "Q [[CC_BUFFER]] can ignore Alistar's Q [[AIRBORNE]], W [[KNOCKBACK]], and E [[STUN]] and continue [[DASH]]. \n However, the [[STUN]] still applies."],
    },
  },
};
