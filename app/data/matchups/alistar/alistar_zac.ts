...
export const alistar_zac: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ...
      en: ["Alistar's Q, W, and E can interrupt Zac's E(준비)를 끊을 수 있음\\\\n알리스타 Q, W로 자크 E(돌진)", "Alistar's E [[STUN]] cannot interrupt Zac's E(돌진). However, the [[STUN]] still applies.", "Alistar's R [[CC_CLEANSE]] can cleanse Zac's Q E [[SLOW]], Q E R [[AIRBORNE]]", "Alistar's R [[CC_CLEANSE]] cannot cleanse Zac's Q [[TETHER]]"],
    },
    zac: {
      ko: [],
      en: [],
