...
export const alistar_jarvaniv: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ...
      en: ["Alistar's Q and W can interrupt Jarvan IV's EQ", "Alistar's E [[STUN]] cannot interrupt Jarvan IV's EQ. However, the [[STUN]] still applies.", "Alistar's R [[CC_CLEANSE]] can cleanse Jarvan IV's EQ [[AIRBORNE]], W [[SLOW]]", "[TODO: 알리스타 W로 자르반 R(벽)을 넘을 수 있음]"],
    },
    jarvaniv: {
      ko: [],
      en: [],
