...
export const alistar_jarvaniv: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ko: ["알리스타 Q의 [[AIRBORNE]], W의 [[KNOCKBACK]]으로 자르반 EQ의 [[DASH]]을 끊을 수 있음.", 
        "알리스타 E의 [[STUN]]로 자르반 EQ의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.", 
        "알리스타 R의 [[CC_CLEANSE]]로 자르반 EQ의 [[AIRBORNE]], W의 [[SLOW]]를 해제할 수 있음."],
