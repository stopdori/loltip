...
export const alistar_sett: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ...
      en: ["[TODO: 알리스타 W로 세트 W를 끊을 수는 없지만 각도를 바꿀수는 있음]", "Alistar's R [[CC_CLEANSE]] can cleanse Sett's E [[SLOW]] [[STUN]], R [[SUPPRESS]]\\n[TODO: 알리스타가 [[SUPPRESS]]을 해제하면 그 즉시 벗어나지만, 세트는 알리스타를 매다 꽂은 것처럼 도착지 주변에 피해를 줌]"],
    },
    sett: {
      ko: [],
      en: [],
