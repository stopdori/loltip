...
export const alistar_singed: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ko: ["R의 [[CC_CLEANSE]]로 신지드 WE의 [[ROOT]], E의 [[GRAB]]을 해제할 수 있음.",
        "R의 [[CC_CLEANSE]]로 신지드 W의 지속[[SLOW]], 지속[[GROUNDED]]는 해제해도 다시 걸림."
      ],
      en: ["R [[CC_CLEANSE]] can cleanse Singed's WE [[ROOT]] and E [[GRAB]].", "Singed's W persistent [[SLOW]] and [[GROUNDED]] will reapply after being cleansed by Alistar's R [[CC_CLEANSE]]."],
    },
    singed: {
