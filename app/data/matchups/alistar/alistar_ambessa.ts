...
export const alistar_ambessa: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    ambessa: {
      ko: ["R의 [[SUPPRESS]]으로 알리스타 W의 [[DASH]]을 끊을 수 있음.", "R의 [[UNSTOPPABLE]]로 알리스타 Q의 [[AIRBORNE]], W의 [[KNOCKBACK]], E의 [[STUN]]을 무시할 수 있음. \n 단, [[UNSTOPPABLE]] 종료 후 [[STUN]]은 남아있음."],
      en: ["R [[SUPPRESS]] can interrupt Alistar's W [[DASH]].", "R [[UNSTOPPABLE]] can ignore Alistar's Q [[AIRBORNE]], W [[KNOCKBACK]], and E [[STUN]]. \n However, the [[STUN]] still applies after [[UNSTOPPABLE]] ends."],
    },
  },
};
