...
export const alistar_lillia: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ...
      en: ["Q [[AIRBORNE]] and W [[KNOCKBACK]] can interrupt Lillia's W [[DASH]]. \n However, W's damage instance can also be interrupted.", "E [[STUN]] cannot interrupt Lillia's W [[DASH]]. \n However, W's damage instance cannot be interrupted either. \n However, the [[STUN]] still applies.", "R [[CC_CLEANSE]] can cleanse Lillia's E [[SLOW]] and R [[SLEEP]]."],
    },
    lillia: {
      ko: [],
      en: [],
