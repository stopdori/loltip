...
export const alistar_caitlyn: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ko: ["Q의 [[AIRBORNE]], W의 [[KNOCKBACK]]으로 케이틀린 E의 [[DASH]]을 끊을 수 있음.", 
    ...
    caitlyn: {
      ko: ["W([[TRAP]])의 [[ROOT]]으로 알리스타 W의 [[DASH]]을 끊을 수 없음. \n 단, [[ROOT]]과 헤드샷은 남아있음."],
      en: ["Caitlyn's W ([[TRAP]]) [[ROOT]] cannot interrupt Alistar's W [[DASH]]. \n However, the [[ROOT]] and headshot still apply."],
    },
  },
};
