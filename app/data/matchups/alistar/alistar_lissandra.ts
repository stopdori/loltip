...
export const alistar_lissandra: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ...
      en: ["R [[CC_CLEANSE]] can cleanse Lissandra's Q [[SLOW]], W [[ROOT]], and R [[STUN]].", "Lissandra's P and R persistent [[SLOW]] will reapply after being cleansed by Alistar's R [[CC_CLEANSE]]."],
    },
    lissandra: {
      ko: [],
      en: [],
