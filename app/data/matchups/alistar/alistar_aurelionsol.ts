...
export const alistar_aurelionsol: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ko: ["알리스타 Q의 [[AIRBORNE]], W의 [[KNOCKBACK]], E의 [[STUN]]로 아우렐리온 솔 Q, W의 [[SKILL_CHANNEL]]을 끊을 수 있음.", 
        "알리스타 R의 [[CC_CLEANSE]]로 아우렐리온 솔 R의 [[STUN]], [[EMPOWERED]]R(천상강림)의 [[SLOW]], [[AIRBORNE]]을 해제할 수 있음. \n 단, 아우렐리온 솔 E의 지속[[SLOW]]는 해제해도 다시 걸림."],
