...
export const alistar_poppy: MatchupSummary = {
  ...
  highlightsByChamp: {
    alistar: {
      ko: ["알리스타 Q의 [[AIRBORNE]], W의 [[KNOCKBACK]]으로 뽀삐 E의 [[DASH]]을 끊을 수 있음.", 
        "알리스타 E의 [[STUN]]로 뽀삐 E의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.", 
        "알리스타 R의 [[CC_CLEANSE]]로 뽀삐 W의 [[STUN]] [[AIRBORNE]] [[GROUNDED]], E의 [[STUN]], R의 [[AIRBORNE]]을 해제할 수 있음. \n 단, [[SKILL_CHARGED]]한 뽀삐 R에 날아가면 해제하고 스킬을 사용해도 유효하지 않고 끝까지 날아감.", 
        "알리스타 R의 [[CC_CLEANSE]]로 뽀삐 Q의 지속[[SLOW]]는 해제해도 다시 걸림."],
      en: ["Alistar's Q [[AIRBORNE]] and W [[KNOCKBACK]] can interrupt Poppy's E [[DASH]].", "Alistar's E [[STUN]] cannot interrupt Poppy's E [[DASH]]. \n However, the [[STUN]] still applies.", "Alistar's R [[CC_CLEANSE]] can cleanse Poppy's W [[STUN]][[AIRBORNE]][[GROUNDED]], E [[STUN]], and R [[AIRBORNE]]. \n However, if Poppy's R [[SKILL_CHARGED]] was fully charged, Alistar will continue to be knocked away even after cleansing.", "Poppy's Q persistent [[SLOW]] will reapply after being cleansed by Alistar's R [[CC_CLEANSE]]."],
    },
    poppy: {
