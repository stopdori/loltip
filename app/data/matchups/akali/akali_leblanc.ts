...
export const akali_leblanc: MatchupSummary = {
  ...
  highlightsByChamp: {
    akali: {
      ko: ["아칼리 E2의 [[HOMING]] [[DASH]]으로 르블랑 W의 [[DASH]]을 따라갈 수 있음.", "아칼리 E1의 [[TRUE_SIGHT]]로 르블랑 P의 [[INVISIBILITY]]를 볼 수 있음. \n 단, E2로 부딪히면 더 이상 모습이 보이지 않음."],
      en: ["Akali's E2 [[HOMING]] [[DASH]] can follow LeBlanc's W [[DASH]].", "Akali's E1 [[TRUE_SIGHT]] can reveal LeBlanc's P [[INVISIBILITY]]. \n However, if E2 hits her, she becomes invisible again."],
    },
    leblanc: {
