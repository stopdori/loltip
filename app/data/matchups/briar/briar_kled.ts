  ...
  highlightsByChamp: {
    briar: {
      ko: ["Q의 [[STUN]]로 클레드 승마폼 E / 낙마폼 Q의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.",
        ...
        "R2의 [[HOMING]] [[DASH]]으로 클레드 P의 [[UNTARGETABLE]] [[TRANSFORM]] / 낙마폼 Q의 [[DASH]] / 승마폼 E의 [[DASH]], R의 [[UNSTOPPABLE]] [[DASH]]을 따라갈 수 있음. \n 단, 클레드와 충돌하면 [[HOMING]] 종료."],
      en: ["Q [[STUN]] cannot interrupt Kled's Mounted Form E or Dismounted Form Q [[DASH]]. \n However, the [[STUN]] still applies.",
        ...
        "R2 [[HOMING]] [[DASH]] can follow Kled's P [[UNTARGETABLE]] [[TRANSFORM]] / Dismounted Form Q [[DASH]] / Mounted Form E [[DASH]] and R [[UNSTOPPABLE]] [[DASH]]. \n However, the [[HOMING]] ends upon colliding with Kled."],
    },
    kled: {
      ko: [],
      en: [],
