  ...
  highlightsByChamp: {
    briar: {
      ...
      en: ["Q [[STUN]] cannot interrupt Ivern's Q [[DASH]]. \n However, the [[STUN]] still applies.",
        "E [[KNOCKBACK]] and R [[FEAR]] can interrupt Ivern's Q [[DASH]].",
    ...
    ivern: {
      ko: ["R로 [[SUMMON]]된 데이지를 브라이어 E의 [[KNOCKBACK]]으로 밀어낼 수 없음."],
      en: ["Daisy, [[SUMMON]]ed by Ivern's R, cannot be pushed by Briar's E [[KNOCKBACK]]."],
    },
  },
};
