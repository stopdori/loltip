  ...
  highlightsByChamp: {
    briar: {
      ko: ["Q의 [[STUN]]로 칼리스타 P의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.",
        ...
        "R2의 [[HOMING]] [[DASH]]으로 칼리스타 R의 [[DASH]]을 따라갈 수 있음. \n 단, 칼리스타와 충돌하면 [[HOMING]] 종료."],
      en: ["Q [[STUN]] cannot interrupt Kalista's P [[DASH]]. \n However, the [[STUN]] still applies.",
        ...
        "R2 [[HOMING]] [[DASH]] can follow Kalista's R [[DASH]]. \n However, the [[HOMING]] ends upon colliding with Kalista."],
    },
    kalista: {
