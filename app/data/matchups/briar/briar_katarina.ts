...
export const briar_katarina: MatchupSummary = {
  ...
  highlightsByChamp: {
    briar: {
      ko: ["Q, E의 [[STUN]] / E의 [[KNOCKBACK]] / R의 [[DISRUPT]], [[FEAR]]로 카타리나 R의 [[SKILL_CHANNEL]]을 끊을 수 있음.",
        "R2의 [[HOMING]] [[DASH]]으로 카타리나 E의 [[BLINK]]을 따라갈 수 있음. \n 단, 카타리나와 충돌하면 [[HOMING]] 종료."],
      en: ["Q and E [[STUN]] / E [[KNOCKBACK]] / R [[DISRUPT]], [[FEAR]] can interrupt Katarina's R [[SKILL_CHANNEL]].",
