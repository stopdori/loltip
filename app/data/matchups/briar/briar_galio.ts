...
export const briar_galio: MatchupSummary = {
  ...
  highlightsByChamp: {
    briar: {
      ko: ["Q, E의 [[STUN]] / E의 [[KNOCKBACK]] / R의 [[DISRUPT]] [[FEAR]]로 갈리오 W의 [[SKILL_CHARGED]], R의 [[SKILL_CHANNEL]]을 끊을 수 있음. \n 단, 갈리오 W는 중단될 때 시전.", 
        "Q의 [[STUN]]로 갈리오 E의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.", 
      ...
      en: ["Q and E [[STUN]] / E [[KNOCKBACK]] / R [[DISRUPT]] [[FEAR]] can interrupt Galio's W [[SKILL_CHARGED]] and R [[SKILL_CHANNEL]]. \n However, Galio's W still triggers when interrupted.",
        "Briar's Q [[STUN]] cannot interrupt Galio's E [[DASH]]. \n However, the [[STUN]] still applies.",
