  ...
  highlightsByChamp: {
    briar: {
      ko: ["Q의 [[STUN]]로 케인, 그암, 다르킨 Q의 돌진단계의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음. \n 단, 회전단계까지 문제없이 시전.",
        "Q의 [[STUN]] / E의 [[KNOCKBACK]] / R의 [[FEAR]]로 케인, 그암, 다르킨 E(벽이동)의 [[SKILL_CHANNEL]]을 끊을 수 있음.",
        "E의 [[CAST_COMMIT]]으로 다르킨 W의 [[AIRBORNE]]에 걸려도 시전을 유지할 수 있음.", 
        "R1의 [[CC_IMMUNE]], R2의 [[UNSTOPPABLE]]로 다르킨 W의 [[AIRBORNE]]을 무시할 수 있음.",
        "R2의 [[HOMING]] [[DASH]]으로 케인 / 그암 / 다르킨 Q, E의 [[DASH]]을 따라갈 수 있음. \n 단, 케인과 충돌하면 [[HOMING]] 종료."],
      en: ["Q [[STUN]] cannot interrupt the dash phase of Kayn's (base, Shadow Assassin, Darkin) Q [[DASH]]. \n However, the [[STUN]] still applies. \n The spin-slash phase still casts normally.",
        "Q [[STUN]], E [[KNOCKBACK]], and R [[FEAR]] can interrupt Kayn's (base, Shadow Assassin, Darkin) E (wall movement) [[SKILL_CHANNEL]].",
        ...
        "R2 [[HOMING]] [[DASH]] can follow Kayn's (base / Shadow Assassin / Darkin) Q and E [[DASH]]. \n However, the [[HOMING]] ends upon colliding with Kayn."],
    },
    kayn: {
      ko: [],
      en: [],
