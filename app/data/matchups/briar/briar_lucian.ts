...
export const briar_lucian: MatchupSummary = {
  ...
  highlightsByChamp: {
    briar: {
      ko: ["Q, E의 [[STUN]] / E의 [[KNOCKBACK]] / R의 [[DISRUPT]] [[FEAR]]로 루시안 R의 [[SKILL_CHANNEL]]을 끊을 수 있음.", 
        "Q의 [[STUN]]로 루시안 E[[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.",
        "E의 [[KNOCKBACK]], R의 [[FEAR]]로 루시안 E의 [[DASH]]을 끊을 수 있음.",
        "R2의 [[HOMING]] [[DASH]]으로 루시안 E의 [[DASH]]을 따라갈 수 있음. \n 단, 루시안과 충돌하면 [[HOMING]] 종료."],
      en: ["Q and E [[STUN]] / E [[KNOCKBACK]] / R [[DISRUPT]] [[FEAR]] can interrupt Lucian's R [[SKILL_CHANNEL]].",
        "Q [[STUN]] cannot interrupt Lucian's E [[DASH]]. \n However, the [[STUN]] still applies.",
