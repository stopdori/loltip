...
export const briar_rammus: MatchupSummary = {
  ...
  highlightsByChamp: {
    briar: {
      ko: ["Q의 [[STUN]], E의 [[KNOCKBACK]], R의 [[FEAR]]로 람머스 Q의 [[TRANSFORM]]을 해제시킬 수 있음.", 
        "E의 [[CAST_COMMIT]]으로 람머스 Q의 [[KNOCKBACK]], E의 [[TAUNT]], R의 [[AIRBORNE]]에 걸려도 시전을 유지할 수 있음.", 
      ...
      en: ["Q [[STUN]], E [[KNOCKBACK]], and R [[FEAR]] can interrupt Rammus's Q [[TRANSFORM]].",
        "Briar's E [[CAST_COMMIT]] allows maintaining the cast even when caught by Rammus's Q [[KNOCKBACK]], E [[TAUNT]], and R [[AIRBORNE]].",
