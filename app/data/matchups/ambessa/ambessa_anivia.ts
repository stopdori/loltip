...
export const ambessa_anivia: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    anivia: {
      ko: ["애니비아 Q의 [[STUN]]로 암베사 P의 [[DASH]]을 끊을 수 없음. 단, [[STUN]]은 남아있음.", "애니비아 W(벽)의 [[AIRBORNE]]으로 암베사 P의 [[DASH]]을 끊을 수 있음.", "애니비아 W(벽)의 [[AIRBORNE]]으로 암베사 Q1, Q2를 시전 중일 때 뒤로 밀어내면 Q1, Q2 범위도 같이 뒤로 밀림."],
      en: ["Anivia's Q [[STUN]] cannot interrupt Ambessa's P [[DASH]]. However, [[STUN]] still applies.", "Anivia's W (wall) [[AIRBORNE]] can interrupt Ambessa's P [[DASH]].", "If Anivia's W (wall) [[AIRBORNE]] knocks Ambessa back while casting Q1 or Q2, the Q1/Q2's area moves with her."],
    },
  },
};
