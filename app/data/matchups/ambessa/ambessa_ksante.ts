...
export const ambessa_ksante: MatchupSummary = {
  ...
  highlightsByChamp: {
    ambessa: {
      ko: ["암베사 R의 [[SUPPRESS]]으로 크산테 E의 [[DASH]]을 끊을 수 있음.", 
        "암베사 R의 [[UNSTOPPABLE]]로 크산테 일반폼, 변신폼 Q3의 [[GRAB]] / 일반폼 W의 [[KNOCKBACK]] / 일반폼 R의 [[SUPPRESS]]을 무시할 수 있음.", 
