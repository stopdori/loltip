...
export const ambessa_briar: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    briar: {
      ko: ["브라이어 Q의 [[STUN]]로 암베사 P를 끊을 수 없음. 단 [[STUN]]은 남아있음.", "브라이어 R의 [[FEAR]]로 암베사 P의 [[DASH]]을 끊을 수 있음."],
      en: ["Briar's Q [[STUN]] cannot interrupt Ambessa's P. However, [[STUN]] still applies.", "Briar's R [[FEAR]] can interrupt Ambessa's P [[DASH]]."],
    },
  },
};
