...
export const ambessa_briar: MatchupSummary = {
  ...
  highlightsByChamp: {
    ambessa: {
      ko: ["R의 [[SUPPRESS]]으로 브라이어 Q, W의 [[DASH]]를 끊을 수 있음.", "R의 [[UNSTOPPABLE]]로 브라이어 Q의 [[STUN]], R의 [[FEAR]]를 무시할 수 있음. \n 단, [[UNSTOPPABLE]] 종료 후 [[STUN]], [[FEAR]]는 남아있음."],
      en: ["R [[SUPPRESS]] can interrupt Briar's Q and W [[DASH]].", "R [[UNSTOPPABLE]] can ignore Briar's Q [[STUN]] and R [[FEAR]]. \n However, the [[STUN]] and [[FEAR]] still apply after [[UNSTOPPABLE]] ends."],
    },
    briar: {
  ...
  common: {
    ko: ["암베사 R의 [[SUPPRESS]]을 브라이어 R1의 [[CC_IMMUNE]]에 사용하면 \n 암베사가 브라이어에게 [[BLINK]] 하지만, 브라이어는 [[SUPPRESS]]과 데미지를 완전히 무시하고 행동을 이어서 진행. [[CLIP:https://www.youtube.com/shorts/8jc0IeTeLos]]",
      "암베사 R의 [[SUPPRESS]]을 브라이어 R2의 [[UNSTOPPABLE]] [[DASH]]에 사용하면 \n 암베사 R이 브라이어에게 적중한 지점에 [[BLINK]] 하지만, 브라이어는 [[SUPPRESS]]과 데미지를 완전히 무시하고 [[DASH]]. [[CLIP:https://www.youtube.com/shorts/V-fGfjtDu5E]]",],
    en: ["If Ambessa's R [[SUPPRESS]] is used on Briar's R1 [[CC_IMMUNE]], \n Ambessa [[BLINK]]s to Briar, but Briar completely ignores the [[SUPPRESS]] and damage and continues her action. [[CLIP:https://www.youtube.com/shorts/8jc0IeTeLos]]",
      "If Ambessa's R [[SUPPRESS]] is used on Briar's R2 [[UNSTOPPABLE]] [[DASH]], \n Ambessa's R [[BLINK]]s to the point where it hit Briar, but Briar completely ignores the [[SUPPRESS]] and damage and continues the [[DASH]]. [[CLIP:https://www.youtube.com/shorts/V-fGfjtDu5E]]"],
  },
};
