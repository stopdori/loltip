...
export const ambessa_poppy: MatchupSummary = {
  ...
  highlightsByChamp: {
    ambessa: {
      ko: ["암베사 R의 [[SUPPRESS]]으로 뽀삐 E의 [[DASH]], R의 [[SKILL_CHANNEL]]을 끊을 수 있음.", 
        "암베사 R의 [[UNSTOPPABLE]]로 뽀삐 E의 [[KNOCKBACK]], [[STUN]] / R의 [[AIRBORNE]], R의 [[SKILL_CHARGED]](홈런)을 무시할 수 있음. \n 단, [[UNSTOPPABLE]] 종료 후 [[STUN]]은 남아있음."],
      en: ["Ambessa's R [[SUPPRESS]] can interrupt Poppy's E [[DASH]] and R [[SKILL_CHANNEL]].", "Ambessa's R [[UNSTOPPABLE]] can ignore Poppy's E [[KNOCKBACK]] [[STUN]], R [[AIRBORNE]], and R [[SKILL_CHARGED]] (home run). \n However, the [[STUN]] still applies after [[UNSTOPPABLE]] ends."],
    },
    poppy: {
