...
export const ambessa_xerath: MatchupSummary = {
  ...
  highlightsByChamp: {
    ambessa: {
      ko: ["R의 [[SUPPRESS]]으로 제라스 Q의 [[SKILL_CHARGED]], R의 [[SKILL_CHANNEL]]을 끊을 수 있음.", 
        "R의 [[UNSTOPPABLE]]로 제라스 E의 [[STUN]]을 무시할 수 있음. \n 단, [[UNSTOPPABLE]] 종료 후 [[STUN]]은 남아있음."],
      en: ["R [[SUPPRESS]] can interrupt Xerath's Q [[SKILL_CHARGED]] and R [[SKILL_CHANNEL]].", "R [[UNSTOPPABLE]] can ignore Xerath's E [[STUN]]. \n However, [[STUN]] remains after [[UNSTOPPABLE]] ends."],
    },
    xerath: {
      ko: [],
      en: [],
