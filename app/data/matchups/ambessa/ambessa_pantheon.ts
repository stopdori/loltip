...
export const ambessa_pantheon: MatchupSummary = {
  ...
  highlightsByChamp: {
    ambessa: {
      ko: ["R의 [[SUPPRESS]]으로 판테온 W의 [[DASH]], R의 [[SKILL_CHANNEL]]을 끊을 수 있음.", 
        "R의 [[UNSTOPPABLE]]로 판테온 W의 [[STUN]]을 무시할 수 있음. \n 단, [[UNSTOPPABLE]] 종료 후 [[STUN]]은 남아있음."],
      en: ["R [[SUPPRESS]] can interrupt Pantheon's W [[DASH]] and R [[SKILL_CHANNEL]].", "R [[UNSTOPPABLE]] can ignore Pantheon's W [[STUN]]. \n However, the [[STUN]] still applies after [[UNSTOPPABLE]] ends."],
    },
    pantheon: {
      ko: [],
      en: [],
