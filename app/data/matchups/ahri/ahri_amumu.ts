...
export const ahri_amumu: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    amumu: {
      ko: ["아무무 Q(붕대)로 아리 R의 [[DASH]]을 끊을 수 없음. \n 단, Q의 [[HOMING]]으로 아리를 따라갈 수 있고 [[STUN]]은 남아있음.", 
        "아무무 R의 [[STUN]]으로 아리 R의 [[DASH]]을 끊을 수 있음."],
      en: ["Amumu's Q cannot interrupt Ahri's R [[DASH]]. However, Q's [[HOMING]] can follow Ahri and the [[STUN]] still applies.", "Amumu's R [[STUN]] can interrupt Ahri's R [[DASH]]."],
    },
  },
};
