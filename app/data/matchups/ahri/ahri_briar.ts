...
export const ahri_briar: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    briar: {
      ...
      en: ["Briar's Q [[STUN]] cannot interrupt Ahri's R [[DASH]]. However, the [[STUN]] still applies.", "Briar's R [[FEAR]] can interrupt Ahri's R [[DASH]].", "Briar's R1 [[CC_IMMUNE]] and R2 [[UNSTOPPABLE]] can briefly ignore Ahri's E [[CHARM]]."],
    },
  },
};
