...
export const ahri_sylas: MatchupSummary = {
  champs: ["ahri", "sylas"],
  summary: {
    ko: [],
    en: [],
  ...
  highlightsByChamp: {
    ahri: {
      ko: ["E([[CHARM]])의 [[KNOCKDOWN]]으로 사일러스 W, E1, E2의 [[DASH]]을 끊을 수 있음. [[EXIST]]"],
      en: ["E ([[CHARM]])'s [[KNOCKDOWN]] can interrupt Sylas's W, E1, and E2 [[DASH]]. [[EXIST]]"],
    },
    sylas: {
