...
export const ahri_malzahar: MatchupSummary = {
  ...
  highlightsByChamp: {
    ahri: {
      ko: ["E의 [[CHARM]]으로 말자하 R의 [[SKILL_CHANNEL]]을 끊을 수 있음. [[EXIST]]"],
      en: ["E [[CHARM]] can interrupt Malzahar's R [[SKILL_CHANNEL]]. [[EXIST]]"],
    },
    malzahar: {
      ...
      en: ["Malzahar's P [[CC_IMMUNE]] can ignore Ahri's E [[CHARM]]. \n However, damage is still applied (reduced).", "Malzahar's W Void Swarm [[SUMMON]] can intercept Ahri's E [[SINGLE]] [[PROJECTILE]].", "Malzahar's R [[SUPPRESS]] can interrupt Ahri's R [[DASH]]."],
    },
  },
};
