...
export const aatrox_anivia: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    anivia: {
      ko: ["애니비아 Q의 [[STUN]]로 아트록스 E의 이동을 끊을 수 없음. 단, [[STUN]]은 남아있음.", "애니비아 W(벽)의 [[AIRBORNE]]으로 아트록스 E의 이동을 끊을 수 있음.", "애니비아 W(벽)의 [[AIRBORNE]]으로 아트록스 Q를 시전 중일 때 뒤로 밀어내면 Q 범위도 같이 뒤로 밀림."],
