...
export const aatrox_jarvaniv: MatchupSummary = {
  ...
  highlightsByChamp: {
    aatrox: {
      ko: ["Q의 [[AIRBORNE]], W [[GRAB]] 효과로 자르반 EQ(깃창)의 [[DASH]]을 끊을 수 있음."],
      en: ["Q [[AIRBORNE]] and W [[GRAB]] effect can interrupt Jarvan IV's EQ [[DASH]]."],
    },
    jarvaniv: {
      ko: ["자르반 EQ(깃창)(준비 단계)의 [[CC_BUFFER]]로 아트록스 Q의 [[AIRBORNE]], W의 [[GRAB]]을 무시할 수 있음."],
