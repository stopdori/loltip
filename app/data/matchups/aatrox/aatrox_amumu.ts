...
export const aatrox_amumu: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    amumu: {
      ...
      en: ["Amumu's Q [[STUN]] cannot interrupt Aatrox's E [[DASH]]. \n However, Amumu's Q [[HOMING]] [[DASH]] can follow Aatrox's E [[DASH]]. \n However, the [[STUN]] still applies.", "Amumu's R [[STUN]] can interrupt Aatrox's E [[DASH]].", "Amumu's Q is affected by Aatrox's Q [[AIRBORNE]], but can still move if the dash phase activates.\nHowever, damage is applied."],
    },
  },
};
