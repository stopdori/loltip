  ...
  highlightsByChamp: {
    ...
    amumu: {
      ko: ["Q의 [[STUN]]로 아트록스 E의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음. \n 단, 아무무 Q의 [[HOMING]] [[DASH]]으로 아트록스 E의 [[DASH]]을 따라갈 수 있음.", 
        "R의 [[STUN]]로 아트록스 E의 [[DASH]]을 끊을 수 있음.", 
        "Q의 [[CC_BUFFER]]로 아트록스 Q의 [[AIRBORNE]]을 무시하고 [[DASH]]할 수 있음."],
      en: ["Q [[STUN]] cannot interrupt Aatrox's E [[DASH]]. \n However, the [[STUN]] still applies. \n However, Amumu's Q [[HOMING]] [[DASH]] can follow Aatrox's E [[DASH]].", "R [[STUN]] can interrupt Aatrox's E [[DASH]].", "Q [[CC_BUFFER]] can ignore Aatrox's Q [[AIRBORNE]] and continue [[DASH]]."],
    },
  },
};
