  ...
  highlightsByChamp: {
    amumu: {
      ko: ["Q의 [[STUN]]로 릴리아 W의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음. \n 단, 아무무 Q의 [[HOMING]] [[DASH]]으로 릴리아 W의 [[DASH]]을 따라갈 수 있음.", 
        "R의 [[STUN]]로 릴리아 W의 [[DASH]]을 끊을 수 있음.", 
        "Q의 [[CC_BUFFER]]로 릴리아 R의 [[SLEEP]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[SLEEP]]은 남아있음."],
      en: ["Q [[STUN]] cannot interrupt Lillia's W [[DASH]]. \n However, the [[STUN]] still applies. \n However, Amumu's Q [[HOMING]] [[DASH]] can follow Lillia's W [[DASH]].", "R [[STUN]] can interrupt Lillia's W [[DASH]].", "Q [[CC_BUFFER]] can ignore Lillia's R [[SLEEP]] and continue [[DASH]]. \n However, the [[SLEEP]] still applies."],
    },
    lillia: {
      ko: [],
      en: [],
