...
export const amumu_blitzcrank: MatchupSummary = {
  ...
  highlightsByChamp: {
    amumu: {
      ko: ["Q의 [[CC_BUFFER]]로 블리츠크랭크 Q의 [[GRAB]], E의 [[AIRBORNE]], R의 [[SILENCE]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[SILENCE]]는 남아있음."],
      en: ["Q [[CC_BUFFER]] can ignore Blitzcrank's Q [[GRAB]], E [[AIRBORNE]], and R [[SILENCE]] and continue [[DASH]]. \n However, the [[SILENCE]] still applies."],
    },
    blitzcrank: {
