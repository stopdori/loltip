  ...
  highlightsByChamp: {
    amumu: {
      ko: ["Q의 [[STUN]]로 브라움 W의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음. \n 단, 아무무 Q의 [[HOMING]] [[DASH]]으로 브라움 W의 [[DASH]]을 따라갈 수 있음.", 
        "R의 [[STUN]]로 브라움 W의 [[DASH]]을 끊을 수 있음.", 
        "Q의 [[CC_BUFFER]]로 브라움 P의 [[STUN]], R의 [[AIRBORNE]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[STUN]]은 남아있음."],
      en: ["Q [[STUN]] cannot interrupt Braum's W [[DASH]]. \n However, the [[STUN]] still applies. \n However, Amumu's Q [[HOMING]] [[DASH]] can follow Braum's W [[DASH]].", "R [[STUN]] can interrupt Braum's W [[DASH]].", "Q [[CC_BUFFER]] can ignore Braum's P [[STUN]] and R [[AIRBORNE]] and continue [[DASH]]. \n However, the [[STUN]] still applies."],
    },
    braum: {
