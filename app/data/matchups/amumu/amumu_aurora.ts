...
export const amumu_aurora: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    aurora: {
      ko: ["E(준비단계)의 [[CC_BUFFER]], R의 [[UNSTOPPABLE]] [[DASH]]으로 아무무 Q, R의 [[STUN]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[STUN]]은 남아있음."],
      en: ["E (wind-up phase) [[CC_BUFFER]] and R [[UNSTOPPABLE]] [[DASH]] can ignore Amumu's Q and R [[STUN]] and continue [[DASH]]. \n However, the [[STUN]] still applies."],
    },
  },
};
