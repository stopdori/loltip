...
export const amumu_bard: MatchupSummary = {
  ...
  highlightsByChamp: {
    amumu: {
      ko: ["아무무 Q의 [[STUN]]로 바드 E(터널)를 끊을 수 없지만 끝까지 따라갈 수 있음.\n단, [[STUN]]은 남아있음.\n단, 바드 E(터널)를 따라가는 도중에 바드와 아무무의 몸이 접촉하면 아무무가 [[DASH]]을 멈춤.", "아무무 R의 [[STUN]]로 바드 E(터널)를 끊을 수 있음.\n단, 바드 E(터널)가 즉시 끊기고 벽에서 나와짐. 가끔 벽 속에 멈춰있는 것으로 보이는데 그건 내 화면에서만 그럼.", "아무무 Q로 바드 Q의 [[STUN]]에 걸리지만 돌진 단계가 발동하면 이동할 수 있음.\n단, 데미지는 유효하고 [[STUN]]도 남아있음."],
