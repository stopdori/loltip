...
export const amumu_poppy: MatchupSummary = {
  ...
  highlightsByChamp: {
    amumu: {
      ko: ["아무무 Q의 [[STUN]]로 뽀삐 E의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음. \n 단, 아무무 Q의 [[HOMING]] [[DASH]]으로 뽀삐 E의 [[DASH]]을 따라갈 수 있음. \n 단, 뽀삐 W([[AURA]])를 사용한 상태라면 아무무가 따라가다 [[AIRBORNE]]과 [[GROUNDED]] [[DEBUFF]] 당함.", 
        "아무무 R의 [[STUN]]로 뽀삐 E의 [[DASH]]을 끊을 수 있음.", 
        "아무무 Q, R의 [[STUN]]로 뽀삐 R의 [[SKILL_CHANNEL]]을 끊을 수 있음.", 
        "아무무 Q의 [[CC_BUFFER]]로 뽀삐 E의 [[KNOCKBACK]] [[STUN]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[STUN]]은 남아있음."],
      en: ["Amumu's Q [[STUN]] cannot interrupt Poppy's E [[DASH]]. \n However, the [[STUN]] still applies. \n However, Amumu's Q [[HOMING]] [[DASH]] can follow Poppy's E [[DASH]]. \n However, if Poppy has W [[AURA]] active, Amumu will be hit by [[AIRBORNE]] and [[GROUNDED]] [[DEBUFF]] while following.", "Amumu's R [[STUN]] can interrupt Poppy's E [[DASH]].", "Amumu's Q and R [[STUN]] can interrupt Poppy's R [[SKILL_CHANNEL]].", "Amumu's Q [[CC_BUFFER]] can ignore Poppy's E [[KNOCKBACK]] [[STUN]] and continue [[DASH]]. \n However, the [[STUN]] still applies."],
    },
    poppy: {
