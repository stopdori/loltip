...
export const aurora_braum: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurora: {
      ko: ["E(준비단계)의 [[CC_BUFFER]], R의 [[UNSTOPPABLE]] [[DASH]]으로 브라움 P의 [[STUN]], R의 [[AIRBORNE]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[STUN]]은 남아있음."],
      en: ["E (ready phase) [[CC_BUFFER]] and R [[UNSTOPPABLE]] [[DASH]] can ignore Braum's P [[STUN]] and R [[AIRBORNE]] and continue [[DASH]]ing. \n However, the [[STUN]] still applies."],
    },
    braum: {
