...
export const aurora_braum: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    braum: {
      ...
      en: ["Braum's E can [[DAMAGE_NULLIFY]] against Aurora's 평타, Q1, E and R\\n[TODO: 단, Q1은 데미지가 들어오지 않지만 Q2는 데미지가 들어옴]\\n[TODO: 오로라 R은 중앙부분에 방패를 들어야 [[DAMAGE_NULLIFY]]]", "[TODO: 브라움 E로 오로라 평타, Q1를 [[INTERCEPT_PROJECTILE]] 할 수 있음.]\\n[TODO: 단, 오로라가 Q2를 사용할 수 있음]"],
    },
  },
};
