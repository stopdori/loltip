...
export const aurora_zyra: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurora: {
      ...
      en: ["E (wind-up phase, dash phase) is affected by Zyra's E [[ROOT]] differently depending on the phase. \n If [[ROOT]]ed during the wind-up phase, the [[DASH]] does not activate. \n If [[ROOT]]ed during the dash phase, she ignores it and continues the [[DASH]]. However, the [[ROOT]] still applies.",
        "E (wind-up phase) [[CC_BUFFER]] can ignore Zyra's R [[AIRBORNE]] and continue [[DASH]].",
        "R [[UNSTOPPABLE]] [[DASH]] can ignore Zyra's E [[ROOT]] and R [[AIRBORNE]] and continue [[DASH]]. \n However, the [[ROOT]] still applies."],
    },
    zyra: {
      ko: [],
      en: [],
