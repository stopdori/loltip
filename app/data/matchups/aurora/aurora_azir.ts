...
export const aurora_azir: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurora: {
      ...
      en: ["Aurora's E (ready phase) [[CC_BUFFER]] can ignore Azir's R [[KNOCKBACK]] and continue [[DASH]]ing. \n However, the [[DASH]] activates while being knocked back by [[KNOCKBACK]].",
        "Aurora's R [[UNSTOPPABLE]] [[DASH]] can ignore Azir's R [[KNOCKBACK]] and continue [[DASH]]ing."],
    },
    azir: {
