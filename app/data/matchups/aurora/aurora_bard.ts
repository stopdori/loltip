...
export const aurora_bard: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurora: {
      ko: ["E(준비단계)의 [[CC_BUFFER]], R의 [[UNSTOPPABLE]] [[DASH]]으로 바드 Q의 [[STUN]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[STUN]]은 남아있음.", 
        "R의 [[UNSTOPPABLE]] [[DASH]]으로 바드 R(존야)을 무시할 수 있음."],
      en: ["E (ready phase) [[CC_BUFFER]] and R [[UNSTOPPABLE]] [[DASH]] can ignore Bard's Q [[STUN]] and continue [[DASH]]ing. \n However, the [[STUN]] still applies.",
        "R [[UNSTOPPABLE]] [[DASH]] can ignore Bard's R (Zhonya)."],
    },
    bard: {
