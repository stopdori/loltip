...
export const aurora_camille: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurora: {
      ko: ["오로라 E(준비단계)의 [[CC_BUFFER]]로 카밀 E의 [[STUN]] / R의 [[SILENCE]], [[KNOCKBACK]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[SILENCE]]은 0.1초 지속이라 사라짐. \n 단, R의 [[KNOCKBACK]]은 밀려나다가 [[DASH]] 발동.", 
        "오로라 R의 [[UNSTOPPABLE]] [[DASH]]으로  카밀 E의 [[STUN]] / R의 [[SILENCE]], [[KNOCKBACK]]을 무시하고 [[DASH]]할 수 있음."],
      en: [""],
    },
    camille: {
      ko: [],
