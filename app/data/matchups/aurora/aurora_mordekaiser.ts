...
export const aurora_mordekaiser: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurora: {
      ko: ["오로라 E(준비단계)의 [[CC_BUFFER]]로 모데카이저 E의 [[GRAB]]을 무시하고 [[DASH]]할 수 있음. \n 단, W의 [[GRAB]]으로 끌려가다가 [[DASH]] 발동.", 
        "오로라 R의 [[UNSTOPPABLE]] [[DASH]]으로 모데카이저 E의 [[AIRBORNE]], W의 [[GRAB]]을 무시하고 [[DASH]]할 수 있음.",        
        "오로라 R의 [[UNSTOPPABLE]]로 모데카이저 R을 무시할 수 있음. \n 모데가 둔기를 전방으로 내밀 때 오로라 R을 사용하면 무시할 수 있음. \n 즉, 이세계로 가지 않음. 모데 R의 쿨타임도 소모."],
      en: [],
    },
    mordekaiser: {
      ko: [],
