...
export const aurora_blitzcrank: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurora: {
      ko: ["E(준비단계)의 [[CC_BUFFER]]로 블리츠크랭크 Q의 [[GRAB]], E의 [[AIRBORNE]], R의 [[SILENCE]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[STUN]], [[SILENCE]]은 남아있음. \n 단, Q의 [[GRAB]]으로 끌려가다가 [[DASH]] 발동.", 
        "R의 [[UNSTOPPABLE]] [[DASH]]으로 블리츠크랭크 Q의 [[GRAB]], E의 [[AIRBORNE]], R의 [[SILENCE]]을 무시하고 [[DASH]]할 수 있음."],
      en: ["E (ready phase) [[CC_BUFFER]] can ignore Blitzcrank's Q [[GRAB]], E [[AIRBORNE]], and R [[SILENCE]] and continue [[DASH]]ing. \n However, [[STUN]] and [[SILENCE]] still apply. \n However, the [[DASH]] activates while being pulled by Q [[GRAB]].",
        "R [[UNSTOPPABLE]] [[DASH]] can ignore Blitzcrank's Q [[GRAB]], E [[AIRBORNE]], and R [[SILENCE]] and continue [[DASH]]ing."],
    },
    blitzcrank: {
