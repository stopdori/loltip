...
export const annie_lucian: MatchupSummary = {
  ...
  highlightsByChamp: {
    annie: {
      ...
      en: ["Annie's P [[STUN]] cannot interrupt Lucian's E [[DASH]]. \n However, the [[STUN]] still applies.", "Annie's R(Tibbers) [[SUMMON]] can block Lucian's W and R [[SINGLE]] [[PROJECTILE]]. \n However, W's additional [[AOE]] damage cannot be blocked."],
    },
    lucian: {
      ko: [],
      en: [],
