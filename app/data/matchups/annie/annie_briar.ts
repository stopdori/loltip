  ...
  highlightsByChamp: {
    annie: {
      ko: ["P의 [[STUN]]로 브라이어 Q, W의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.", 
        "R로 [[SUMMON]]된 티버를 브라이어 E의 [[KNOCKBACK]]으로 밀어낼 수 있음."],
      en: ["P [[STUN]] cannot interrupt Briar's Q and W [[DASH]]. \n However, the [[STUN]] still applies.",
        "Annie's R [[SUMMON]]ed Tibbers can be pushed by Briar's E [[KNOCKBACK]]."],
    },
    briar: {
      ko: ["E의 [[CAST_COMMIT]]으로 애니 P의 [[STUN]]에 걸려도 시전을 유지할 수 있음.",
