  ...
  highlightsByChamp: {
    ...
    briar: {
      ko: ["E의 [[KNOCKBACK]]으로 애니 R로 [[SUMMON]]된 티버를 [[KNOCKBACK]] 할 수 있음.",
        "E의 [[CAST_COMMIT]]으로 애니 P의 [[STUN]]에 걸려도 시전을 유지할 수 있음.",
        "R1의 [[CC_IMMUNE]], R2의 [[UNSTOPPABLE]]로 애니 P의 [[STUN]]을 무시할 수 있음. \n 단, [[UNSTOPPABLE]] 종료 후 [[STUN]]은 남아있음."],
      en: ["Briar's E [[KNOCKBACK]] can knock back Annie's R [[SUMMON]]ed Tibbers.",
        "Briar's E [[CAST_COMMIT]] allows maintaining the cast even if hit by Annie's P [[STUN]].",
