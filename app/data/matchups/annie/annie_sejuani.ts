  ...
  highlightsByChamp: {
    annie: {
      ko: ["P의 [[STUN]]로 세주아니 Q의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.", 
        "R(티버)의 [[SUMMON]]으로 세주아니 R의 [[PIERCE_MINION]] [[PROJECTILE]]를 막을 수 없음."],
      en: ["P [[STUN]] cannot interrupt Sejuani's Q [[DASH]]. \n However, the [[STUN]] still applies.", "R(Tibbers) [[SUMMON]] cannot block Sejuani's R [[PIERCE_MINION]] [[PROJECTILE]]."],
    },
    sejuani: {
      ko: [],
      en: [],
