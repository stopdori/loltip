...
export const bard_braum: MatchupSummary = {
  ...
  highlightsByChamp: {
    bard: {
      ...
      en: ["Bard's Q [[STUN]] cannot interrupt Braum's W [[DASH]]. \n However, the [[STUN]] still applies.",
        "Bard's R (Zhonya) can interrupt Braum's W [[DASH]]."],
    },
    braum: {
      ...
      en: ["Braum's E(Shield) can [[DAMAGE_NULLIFY]] and [[INTERCEPT_PROJECTILE]] against Bard's basic attacks and Q\\nIf Braum blocks Q with his shield from the front, it does not pierce through\\nIf Braum blocks a piercing Q, both targets are [[STUN]]ned", "Braum's P [[STUN]] cannot interrupt Bard's E (wall-travel). However, [[STUN]] still applies.", "If Braum is holding his E (Shield) and gets hit by Bard's R (Zhonya), the shield effect does not activate.", "Braum's R [[AIRBORNE]] can interrupt Bard's E (wall-travel)."],
    },
  },
};
