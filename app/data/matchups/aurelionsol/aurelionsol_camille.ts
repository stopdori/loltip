...
export const aurelionsol_camille: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurelionsol: {
      ko: ["R의 [[STUN]]으로 카밀 E의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음. \n 단, 카밀 E의 대기 단계에 [[STUN]]이 남아 있으면, 돌진 단계를 사용할 수 없음.", 
        "R(천상강림)의 [[AIRBORNE]]으로 카밀 E의 [[DASH]]을 끊을 수 있음."],
      en: ["R [[STUN]] cannot interrupt Camille's E [[DASH]]. \n However, the [[STUN]] still applies. \n However, if the [[STUN]] remains during Camille's E waiting phase, she cannot use the dash phase.",
        "R (Falling Star) [[AIRBORNE]] can interrupt Camille's E [[DASH]]."],
    },
    camille: {
      ko: [],
      en: [],
