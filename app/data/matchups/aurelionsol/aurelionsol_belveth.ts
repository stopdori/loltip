...
export const aurelionsol_belveth: MatchupSummary = {
  ...
  highlightsByChamp: {
    aurelionsol: {
      ko: ["R의 [[STUN]]으로 벨베스 Q의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음.", 
        "R(천상강림)의 [[AIRBORNE]]으로 벨베스 Q의 [[DASH]]을 끊을 수 있음.", 
        "R의 [[STUN]], R(천상강림)의 [[AIRBORNE]]으로 벨베스 E의 [[SKILL_CHANNEL]]을 끊을 수 있음."],
      en: ["R [[STUN]] cannot interrupt Bel'Veth's Q [[DASH]]. \n However, the [[STUN]] still applies.",
        "R (Falling Star) [[AIRBORNE]] can interrupt Bel'Veth's Q [[DASH]].",
        "R [[STUN]] and R (Falling Star) [[AIRBORNE]] can interrupt Bel'Veth's E [[SKILL_CHANNEL]]."],
    },
    belveth: {
