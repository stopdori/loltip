...
export const aurelionsol_aurora: MatchupSummary = {
  ...
  highlightsByChamp: {
    ...
    aurora: {
      ko: ["E(준비단계)의 [[CC_BUFFER]], R의 [[UNSTOPPABLE]] [[DASH]]으로 아우렐리온 솔 R의 [[STUN]], [[EMPOWERED]] R의 [[AIRBORNE]]을 무시하고 [[DASH]]할 수 있음. \n 단, [[STUN]]은 남아있음."],
      en: ["E (ready phase) [[CC_BUFFER]] and R [[UNSTOPPABLE]] [[DASH]] can ignore Aurelion Sol's R [[STUN]] and [[EMPOWERED]] R [[AIRBORNE]] and continue [[DASH]]ing. \n However, the [[STUN]] still applies."],
    },
  },
};
