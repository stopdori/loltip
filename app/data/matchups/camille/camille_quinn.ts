  ...
  highlightsByChamp: {
    camille: {
      ko: ["E1( 투척 단계 )의 [[CC_BUFFER]]로 퀸 E의 [[KNOCKBACK]]을 무시하고 E1( 벽돌진 단계 )의 [[DASH]]을 할 수 있음.", 
        "E의 [[KNOCKBACK]], [[STUN]] / R의 [[DISRUPT]], [[KNOCKBACK]]으로 퀸 R의 [[SKILL_CHANNEL]], R의 [[TRANSFORM]]을 해제시킬 수 있음.", 
      ...
      en: ["Camille's E1 (Throw phase) [[CC_BUFFER]] can ignore Quinn's E [[KNOCKBACK]] and continue into the E1 (Wall-dash phase) [[DASH]].",
        "Camille's E [[KNOCKBACK]], [[STUN]] / R [[DISRUPT]], [[KNOCKBACK]] can interrupt Quinn's R [[SKILL_CHANNEL]] and [[TRANSFORM]].",
