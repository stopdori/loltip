...
export const braum_ekko: MatchupSummary = {
  ...
  highlightsByChamp: {
    braum: {
      ko: ["브라움 E(방패)로 에코 평타, Q, E(평타), R [[DAMAGE_NULLIFY]] 할 수 있음. 단, R은 중심부방향에 유효 ", "브라움 E(방패)로 에코 Q를 [[INTERCEPT_PROJECTILE]] 할 수 있음", "브라움 P의 [[STUN]]로 에코 E을 끊을 수 없음. 단, [[STUN]]은 남아있음", "브라움 R의 [[AIRBORNE]]으로 에코 E를 끊을 수 있음"],
