...
export const braum_diana: MatchupSummary = {
  ...
  highlightsByChamp: {
    braum: {
      ko: ["브라움 E(방패)로 다이애나 평타, Q, W, E, R을 막을([[DAMAGE_NULLIFY]]) 수 있음", "브라움 E(방패)로 다이애나 Q를 [[INTERCEPT_PROJECTILE]] 할 수 있음", "브라움 P의 [[STUN]]로 다이애나 E을 끊을 수 없음. 단, [[STUN]]은 남아있음", "브라움 R의 [[AIRBORNE]]으로 다이애나 E를 끊을 수 있음"],
