// app/data/matchups/cassiopeia/cassiopeia_renekton.ts
import type { MatchupSummary } from "../_types";

export const cassiopeia_renekton: MatchupSummary = {
  champs: ["cassiopeia", "renekton"],
  summary: {
    ko: [],
    en: [],
  },
  highlightsByChamp: {
    cassiopeia: {
      ko: ["R의 [[STUN]]로 레넥톤 E의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음."],
