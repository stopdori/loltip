// app/data/matchups/cassiopeia/cassiopeia_xinzhao.ts
import type { MatchupSummary } from "../_types";

export const cassiopeia_xinzhao: MatchupSummary = {
  champs: ["cassiopeia", "xinzhao"],
  summary: {
    ko: [],
    en: [],
  },
  highlightsByChamp: {
    cassiopeia: {
      ko: ["R의 [[STUN]]로 신 짜오 E의 [[DASH]]을 끊을 수 없음. \n 단, [[STUN]]은 남아있음."],
