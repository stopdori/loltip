...
const ambessa: ChampData = {
  ...
  notes: {
    ko: [
    "암베사 P로 [[WALL_HOP]] 불가.", "P의 [[ENERGY_RESTORE]]은 QWER스킬을 사용하면 P(버프)스택이 쌓이고, 평타를 치면 P(버프)스택을 소모하여 기력을 회복.", "Q1를 맞히면 Q2를 사용 할 수 있게됨.\nQ1을 맞히지 못하면 Q2 없음.", "R의 스킬의 [[LIFESTEAL]], [[AR_PEN]]은 기본지속 효과. 스킬 찍으면 항상 발동.\n사실상 모든스킬 피흡.", "R은 경로상 맨 뒤 적챔피언만 적중."
  ],
