  ...
  notes: {
    skill: {
      ...
      note2: {
        ...
        en: ["Pyke's P converts 14 HP into 1 AD", "Using E then W when recalling is effective.\nUsing W then E breaks [[CAMOUFLAGE]]", "[[CAMOUFLAGE]] does not break on flash during W", "E's [[STUN]] triggers as the returning dagger comes back", "R has two phases: wind-up / blink.\nCC during the wind-up phase is valid, but the [[BLINK]] phase still triggers and Pyke moves.\nThere is no CC immunity during the [[BLINK]] phase.\nIf CC duration remains when Pyke lands, the CC effect still applies."]
        },
    },
    vision: { ko: [], en: [] },
    gimmick: { ko: [], en: [] },
