...
const mel: ChampData = {
  ...
  gimmick: {
    P: ["BUFF_STACK", "DEBUFF_STACK", "ON_HIT"],
    Q: ["DMG_MAGIC", "TIMING_CAST", "PROJECTILE", "BUFF_STACK", "DEBUFF_STACK"],
    W: ["REFLECT", "DMG_MAGIC", "PROJECTILE", "BUFF_STACK", "DEBUFF_STACK"],
