...
const ornn: ChampData = {
  ...
  notes: {
    ko: [
    "P로 아이템 강화는 13레벨에 1번 슬롯부터 강화함\n오른 걸작들은 1000골드 가치만큼 강화 https://leagueoflegends.fandom.com/wiki/Legendary_item", "[[Q_FLASH]], [[W_FLASH]], [[E_FLASH]], 안됨", "[[R_FLASH]]는 R2 타이밍에 정말 빠르게 R2플 하면 가능", "오른 Q(기둥)에 텔 안타짐", "W를 마지막에 맞히면 상대가 불안정 상태가 되는데, 이때 공격하면 CC 지속시간 증가와 넉백이 있음", "E는 벽에 부딪혀야 [[AIRBORNE]]이 발동함\n상대팀이 만든 벽이라면 파괴함", "R은 오는거 가는거 다 불안정상태를 부여함\nR2타는 [[UNSTOPPABLE]]가 아님"
  ],
