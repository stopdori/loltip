...
const warwick: ChampData = {
  ...
  skills: {
    P: ["LIFESTEAL"],
    Q: ["LIFESTEAL", "WALL_HOP", "UNSTOPPABLE_CHANNEL"],
    W: ["AS_UP", "MS_UP"],
    E: ["DMG_REDUCE", "FEAR", "UNSTOPPABLE_CHANNEL"],
    R: ["LIFESTEAL", "SUPPRESS", "WALL_HOP", "UNSTOPPABLE_CAST"],
    ETC: [],
  },
