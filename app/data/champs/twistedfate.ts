...
const twistedfate: ChampData = {
  ...
  notes: {
    ko: [
    "W 카드 순서는\n파랑([[MANA_RESTORE]]) 빨강([[SLOW]]) 노랑([[STUN]])", "W1을 사용하고 CC에 걸려도 카드의 순서는 계속 변하고 W2로 카드를 집을 수 있음.", "골카를 들고 대상에게 우클릭한 후 점멸을 누르면 점멸골카가 예쁘게 나감", "E의 [[AS_UP]]는 지속효과", "R의 [[TRUE_SIGHT]]는 방어막류(밴시, 밤끝 포함)로 막아짐"
  ],
