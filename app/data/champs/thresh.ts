...
const thresh: ChampData = {
  ...
  notes: {
    skill: {
      ...
      note2: {
        ko: [
        "[[Q_FLASH]], [[E_FLASH]], [[R_FLASH]] 불가. \n Q 돌진단계에 점멸은 되긴 함", 
        "Q는 두단계로 나뉨 투척/돌진단계 \n 투척단계에 [[IMMOBILIZING]]를 맞아도 대부분 유효\n돌진단계에 [[IMMOBILIZING]]를 맞으면 끊길 수 있음", 
        "W(랜턴)은 아군의 진행방향에 깔아주면 좋음"
      ],
        en: ["[[Q_FLASH]], [[E_FLASH]], [[R_FLASH]] not possible.\nFlash during Q dash phase technically works", "Q has two phases: throw / dash.\nBeing hit by [[IMMOBILIZING]] during the throw phase is mostly still valid.\n[[IMMOBILIZING]] during the dash can interrupt it", "W (lantern) is best placed in the ally's direction of movement"]
        },
    },
    vision: { ko: [], en: [] },
    gimmick: { ko: [], en: [] },
