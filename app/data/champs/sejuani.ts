  ...
  notes: {
    skill: {
      ...
      note2: {
        ...
        "P는 [[SLOW]]만 면역임", "세주아니에게 [[STUN]] 당한 대상을 처음 평타로 때리면 [[DMG_MAGIC]] 추가.", "W에 [[SLOW]]는 2타만 적용", "R은 사거리 1/4 보다 먼 대상에게 적중 할 때 여러가지 효과가 추가 되거나 증가함\n[[SLOW]]와 광역피해는 1/4이상일때만", "R은 처음에 적중하거나 장판이 깔리면 광역 [[SLOW]]를 걸고. \n [[ZONE]]이 터지면서 한번 더 [[SLOW]].", "R은 적중피해를 입었다면 장판피해는 입지 않음."
