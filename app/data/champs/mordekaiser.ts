...
const mordekaiser: ChampData = {
  ...
  skills: {
    ...
    R: ["R_FLASH", "NEAR_SIGHT", "TRUE_SIGHT"],
  },
  ...
  notes: {
    skill: {
      ...
      note2: {
        ko: [
        "Q는 단일 대상 명중 시 피해가 증가함", "R을 시전하는 도중 대상과의 거리가 모데의 이세계 크기보다 멀어지면,\nR 시전이 취소되고 쿨타임을 소모하지 않음.", "R을 시전하는 도중 대상이 [[STEALTH]]류로 숨어도, R의 [[TRUE_SIGHT]]로 모습이 보이고 이세계로 이동.", "R로 다른세계로 이동했을 때, 밖의 상대 미니언이 죽으면 경험치가 들어오지 않음.", "R의 디테일한 판정은 챔피언별로 하단 박스에 정리."
      ],
