    ...
    skill: {
      ...
      note1: {
        ...
        ko: [
          ...
          "E는 [[DMG_REDUCE]], [[OMNIVAMP]] \n [[OMNIVAMP]]은 [[LIFESTEAL]]에 비례. \n 체력이 낮은대상 부터 공격.",
        ...
        en: [
          ...
          "E grants [[DMG_REDUCE]] and [[OMNIVAMP]].\n[[OMNIVAMP]] scales proportionally to [[LIFESTEAL]].\nPrioritizes attacking the lowest-health target.",
      ...
      note2: {
        ko: [
        "P [[STACKING]]은 적 챔피언, 에픽 킬 관여시 2스택. \n 대포, 정글몹 킬 관여 시 1스택. \n R로 공허산호 주울 때 1스택.\n 대상 주변에 보랏빛 띠가 생기면 조건 충족.", 
        "E는 [[INVISIBILITY]]으로 보이지 않아도 공격할 수 있음.", 
        "R(본모습) 상태일 때 주변에서 죽는 미니언들은 \n 공허 빨판상어로 소환됨. \n 적군, 아군 미니언 모두 태어남. \n 빨판상어에 [[ALLY_TP_OK]] 가능.", 
        "[[W_FLASH]] 안됨", 
        "E 시전중에 CC맞으면 풀림"
      ],
        en: [
