...
const rammus: ChampData = {
  ...
  skills: {
    ...
    W: ["UNSTOPPABLE_CHANNEL"],
    E: ["E_FLASH", "TAUNT", "UNSTOPPABLE_CAST"],
  ...
  notes: {
    ko: [
    "P [[AD_UP]]은 방마저 비례", "R은 설명에 [[CC_IMMUNE]]이 없지만, 점프해서 날아갈 때 람머스 체력바 위에 [[CC_IMMUNE]]이 생김. 도착하면 끝.", "R의 점프 거리가 이속 비례임\n[[AIRBORNE]]은 Q상태일 때만 가능함\n[[SLOW]]도 지역에 3회 추가 적용임",
  ],
