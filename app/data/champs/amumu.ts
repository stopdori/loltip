    ...
    skill: {
      ...
      note2: {
        ...
        en: [
          ...
          "Q is split into two phases: throwing phase / dash phase.\nEven if hit by CC during the throwing phase, if the bandage connects, the dash phase activates and Amumu still moves.\nHowever, the CC remains active.",
          "Q's [[HOMING]] [[DASH]] follows the target even if they use [[CC_CLEANSE]] to remove the [[STUN]] \n or use mobility abilities like Flash, Galeforce, etc.",
          "Q appears to have a maximum follow distance/time — roughly the distance between the 1st and 2nd mid lane towers.",
