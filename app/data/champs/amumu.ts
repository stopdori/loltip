  ...
  gimmick: {
    ...
    skill: {
      ...
      note2: {
        ...
        "Q의 [[HOMING]] [[DASH]]은 \n 상대가 Q에 맞고 [[CC_CLEANSE]]로 [[STUN]]을 해제하고 \n 점멸, 벨트, 등등 이동기를 사용해도 따라감.",
        "Q로 따라갈 수 있는 \n 최대 거리? 시간?이 있는것으로 추정됨\n약 미드 1~2차 타워 사이거리 정도.", 
        "R은 버튼을 누르고 스킬이 발동하는 데까지 딜레이가 있음. \n [[TIMING_CAST]] 꽤 체감됨."
      ],
        en: ["R cannot be used while Q is in flight", "Q is split into two phases: throwing phase / dash phase.\nEven if hit by CC during the throwing phase, if the bandage connects, the dash phase activates and Amumu still moves.\nHowever, the CC remains active.", "Q's [[HOMING]] [[DASH]] follows the target even if they use [[CC_CLEANSE]] to remove the [[STUN]] \n or use mobility abilities like Flash, Galeforce, etc.", "Q appears to have a maximum follow distance/time — roughly the distance between the 1st and 2nd mid lane towers.", "There is a delay (wind-up) between pressing the R button and the skill being activated. \n [[TIMING_CAST]] is quite noticeable."]
        },
    },
    vision: { ko: [], en: [] },
    gimmick: { ko: [], en: [] },
