...
const olaf: ChampData = {
  ...
  notes: {
    skill: {
      note2: {
        ko: [
        "P는 체력이 낮을수록 [[AS_UP]], [[LIFESTEAL]]", "Q(도끼)는 던지면 바닥에 떨어지는데 \n 몸으로 주우면 쿨타임이 감소함.", "Q는 최소 투척 거리가 있음. \n 벽에 붙어서 벽으로 던지면 바로 주울수 있음.", "[[Q_FLASH]]은 가능하지만 최대 사거리가 늘어나지 않음.", "[[Q_FLASH]] 가까운 거리에 던지면 최소 투척 거리 때문에 엉뚱하게 날아갈 수 있음.", "Q(도끼)에 텔 안타짐", "W의 [[SHIELD]]은 체력이 낮을수록 증가.", "E는 스킬 소모값이 체력.", "E로 처치하면 체력 소모값을 돌려 줌.\n평타를 치면 1초, 정글몹 치면 2초 쿨감.", "R은 사용하면 지속시간이 엄청 짧지만\n평타, E를 맞히면 지속시간 초기화."
      ],
