...
const alistar: ChampData = {
  ...
  gimmick: {
    ...
    E: { phases: [
      { label: { ko: "E", en: "E" }, tags: ["DMG_MAGIC", "AOE", "DOT"] },
      { label: { ko: "E On-Hit", en: "On-Hit"  }, tags: ["ST_CONDITIONAL", "DMG_MAGIC", "ON_HIT", "BUFF_STACK"]},
    ] },
    R: ["BUFF_FORM"],
  },
